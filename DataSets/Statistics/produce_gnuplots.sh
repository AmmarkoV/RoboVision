...
gnuplot -e 'set terminal png; set output "disparity_map_times.png"; set xlabel "RoboVision Coverage in seconds"; set ylabel "Average Disparity Mapping Proccesing time in microseconds"; plot "hypervisor_disparity_mapping_performance.dat" using 3:2  title "Disparity Mapping Performance Graph"'
