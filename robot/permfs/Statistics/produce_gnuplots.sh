...
gnuplot -e 'set terminal png; set output "disparity_scale.png"; set xlabel "Depth Units"; set ylabel "Centimeters"; plot "disparity_scale.dat" using 1:2 with lines title "Disparity Scale"'
